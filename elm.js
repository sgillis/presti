...
Elm.Experiment = Elm.Experiment || {};
Elm.Experiment.make = function (_elm) {
   "use strict";
   _elm.Experiment = _elm.Experiment || {};
   if (_elm.Experiment.values)
...
Elm.HtmlConstructs = Elm.HtmlConstructs || {};
Elm.HtmlConstructs.make = function (_elm) {
   "use strict";
   _elm.HtmlConstructs = _elm.HtmlConstructs || {};
   if (_elm.HtmlConstructs.values)
   return _elm.HtmlConstructs.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "HtmlConstructs",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm);
   var column = F2(function (size,
   hs) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class(A2($Basics._op["++"],
      "small-",
      A2($Basics._op["++"],
      $Basics.toString(size),
      " columns")))]),
      hs);
   });
   ...
   _L.fromArray([]),
   _L.fromArray([]))]));
   _elm.HtmlConstructs.values = {_op: _op
                                ,row: row
                                ,column: column
                                ,prestiTitle: prestiTitle
                                ,pageBreak: pageBreak};
   return _elm.HtmlConstructs.values;
};
...
Elm.Instructions.make = function (_elm) {
   ...
   var view = function (model) {
      ...
      _L.fromArray([$Html$Attributes.$class("container")]),
      _L.fromArray([$HtmlConstructs.prestiTitle
                   ,$HtmlConstructs.row(_L.fromArray([$Html.text("Some instructions")]))
                   ,$Slider.slider(model.slider)
                   ,$HtmlConstructs.row(_L.fromArray([$Screens.previousScreenButton
                                                     ,$Sound.replayButton
                                                     ,$Screens.nextScreenButton]))]));
   };
   var emptyInstructions = {_: {}
                           ,slider: 50
                           ,sound: {_: {}
                                   ,playSound: true
                                   ,soundId: 1}};
   var NoOp = {ctor: "NoOp"};
   var Instructions = F2(function (a,
   b) {
      return {_: {}
             ,slider: b
             ,sound: a};
...
Elm.Presti = Elm.Presti || {};
Elm.Presti.make = function (_elm) {
   "use strict";
   _elm.Presti = _elm.Presti || {};
   if (_elm.Presti.values)
   ...
   var refreshFoundation = _P.portOut("refreshFoundation",
   _P.outgoingSignal(function (v) {
      return v;
   }),
   $Time.every($Time.second));
   var donePlaying = _P.portIn("donePlaying",
   _P.incomingSignal(function (v) {
   ...
   view,
   model);
   var soundIdSignal = A2($Signal._op["<~"],
   function (_) {
      return _.soundId;
   },
   A2($Signal._op["<~"],
   getSound,
   model));
   var soundId = _P.portOut("soundId",
   _P.outgoingSignal(function (v) {
      return v;
   }),
   soundIdSignal);
   var playSoundSignal = A2($Signal.merge,
   A2($Signal._op["<~"],
   function (_) {
      return _.playSound;
   },
   ...
   getSound,
   model)),
   $Signal.subscribe($Sound.soundChannel));
   var playSound = _P.portOut("playSound",
   _P.outgoingSignal(function (v) {
      return v;
   }),
   playSoundSignal);
...
Elm.Questionnaire.make = function (_elm) {
   "use strict";
   _elm.Questionnaire = _elm.Questionnaire || {};
   if (_elm.Questionnaire.values)
   ...
   var Opmerking10 = function (a) {
      return {ctor: "Opmerking10"
             ,_0: a};
   };
   var Vraag10 = function (a) {
      return {ctor: "Vraag10"
             ,_0: a};
   };
   var Opmerking9 = function (a) {
      return {ctor: "Opmerking9"
             ,_0: a};
   };
   var Vraag9 = function (a) {
      return {ctor: "Vraag9"
             ,_0: a};
   };
   var Opmerking8 = function (a) {
      return {ctor: "Opmerking8"
             ,_0: a};
   };
   var Vraag8 = function (a) {
      return {ctor: "Vraag8"
             ,_0: a};
   };
   var Opmerking7 = function (a) {
      return {ctor: "Opmerking7"
             ,_0: a};
   };
   var Vraag7 = function (a) {
      return {ctor: "Vraag7"
             ,_0: a};
   };
   var Opmerking6 = function (a) {
      return {ctor: "Opmerking6"
             ,_0: a};
   };
   var Vraag6 = function (a) {
      return {ctor: "Vraag6"
             ,_0: a};
   };
   var Opmerking5 = function (a) {
      return {ctor: "Opmerking5"
             ,_0: a};
   };
   var Vraag5 = function (a) {
      return {ctor: "Vraag5"
             ,_0: a};
   };
   var Opmerking4 = function (a) {
      return {ctor: "Opmerking4"
             ,_0: a};
   };
   var Vraag4 = function (a) {
      return {ctor: "Vraag4"
             ,_0: a};
   };
   var Opmerking3 = function (a) {
      return {ctor: "Opmerking3"
             ,_0: a};
   };
   var Vraag3 = function (a) {
      return {ctor: "Vraag3"
             ,_0: a};
   };
   var Opmerking2 = function (a) {
      return {ctor: "Opmerking2"
             ,_0: a};
   };
   var Vraag2 = function (a) {
      return {ctor: "Vraag2"
             ,_0: a};
   };
   var Opmerking1 = function (a) {
      return {ctor: "Opmerking1"
             ,_0: a};
   };
   var Vraag1 = function (a) {
      return {ctor: "Vraag1"
             ,_0: a};
   };
   var Geslacht = function (a) {
      return {ctor: "Geslacht"
             ,_0: a};
   };
   var Leeftijd = function (a) {
      return {ctor: "Leeftijd"
             ,_0: a};
   };
   var NoOp = {ctor: "NoOp"};
   ...
   var commentsField = F2(function (val,
   toUpdate) {
      return $HtmlConstructs.row(_L.fromArray([A2($HtmlConstructs.column,
                                              6,
                                              _L.fromArray([$Html.text("Opmerkingen")]))
                                              ,A2($HtmlConstructs.column,
                                              6,
   ...
   _elm.Questionnaire.values = {_op: _op
                               ...
                               ,Vraag3: Vraag3
                               ,Opmerking3: Opmerking3
                               ,Vraag4: Vraag4
                               ,Opmerking4: Opmerking4
                               ,Vraag5: Vraag5
                               ,Opmerking5: Opmerking5
                               ,Vraag6: Vraag6
                               ,Opmerking6: Opmerking6
                               ,Vraag7: Vraag7
                               ,Opmerking7: Opmerking7
                               ,Vraag8: Vraag8
                               ,Opmerking8: Opmerking8
                               ,Vraag9: Vraag9
                               ,Opmerking9: Opmerking9
                               ,Vraag10: Vraag10
...
Elm.Screens.make = function (_elm) {
   "use strict";
   _elm.Screens = _elm.Screens || {};
   if (_elm.Screens.values)
   return _elm.Screens.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var screenChannel = $Signal.channel(NextScreen);
   var nextScreenButton = A2($Html.button,
   _L.fromArray([$Html$Events.onClick(A2($Signal.send,
   screenChannel,
   NextScreen))]),
   _L.fromArray([$Html.text("Volgende scherm")]));
   var PreviousScreen = {ctor: "PreviousScreen"};
   var previousScreenButton = A2($Html.button,
   _L.fromArray([$Html$Events.onClick(A2($Signal.send,
   screenChannel,
   PreviousScreen))]),
   ...
   _elm.Screens.values = {_op: _op
                         ...
                         ,previousScreenButton: previousScreenButton
...
Elm.Slider.make = function (_elm) {
   ...
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $HtmlConstructs = Elm.HtmlConstructs.make(_elm);
   var rightCircle = function (x) {
      return $Graphics$Collage.moveX(100)($Graphics$Collage.filled($Color.blue)($Graphics$Collage.circle($Basics.toFloat(x))));
   };
   var leftCircle = function (x) {
      return $Graphics$Collage.moveX(-100)($Graphics$Collage.filled($Color.blue)($Graphics$Collage.circle($Basics.toFloat(x))));
   };
   var slider = function (size) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([$HtmlConstructs.row(_L.fromArray([A2($Html.div,
                   ...
                   405,
                   205,
                   _L.fromArray([leftCircle(101 - size)
                                ,rightCircle(size + 1)])))]))]))
                   ,$HtmlConstructs.row(_L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("small-12 columns")]),
                   _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("range-slider")
                                ,A2($Html$Attributes.attribute,
                                "data-slider",
                                $Basics.toString(size))
                                ,$Html$Attributes.id("slider")]),
                   _L.fromArray([A2($Html.span,
                                _L.fromArray([$Html$Attributes.$class("range-slider-handle")]),
                                _L.fromArray([]))
                                ,A2($Html.span,
                                _L.fromArray([$Html$Attributes.$class("range-slider-active-segment")]),
                                _L.fromArray([]))
                                ,A2($Html.input,
   ...
   var emptySlider = 0;
   var DragSlider = function (a) {
      return {ctor: "DragSlider"
             ,_0: a};
   };
   var NoOp = {ctor: "NoOp"};
...
Elm.Sound = Elm.Sound || {};
Elm.Sound.make = function (_elm) {
   "use strict";
   _elm.Sound = _elm.Sound || {};
   if (_elm.Sound.values)
   return _elm.Sound.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Html$Events = Elm.Html.Events.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var soundChannel = $Signal.channel(true);
   var sendPlay = A2($Signal.send,
   soundChannel,
   true);
   ...
   var SoundPlayed = function (a) {
      return {ctor: "SoundPlayed"
             ,_0: a};
   };
   var NoOp = {ctor: "NoOp"};
   var emptyModel = {_: {}
