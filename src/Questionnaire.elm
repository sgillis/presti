...
view q =
  div
    ...
    [ questions q
    , pageBreak
    , if validateModel q then
        row [ Screens.nextScreenButton ]
      else
        row
          [ button
              [ onClick updateChannel.address TrySend ]
...
questions q =
  div
    ...
    , selectionField
        ...
        Vraag11
    , selectionField
        [ ( "a", "België - West-Vlaanderen" )
        , ( "b", "België - Oost-Vlaanderen" )
        , ( "c", "België - Antwerpen of Vlaams-Brabant" )
        , ( "d", "België - Limburg" )
        , ( "e", "Nederland - Zeeland" )
        , ( "f", "Nederland - Noord-Brabant" )
        , ( "g", "Nederland - Limburg" )
        , ( "h", "Nederland - Noord-Holland, Zuid-Holland of Utrecht" )
        , ( "i", "Nederland - Groningen, Gelderland, Overijssel, Drenthe of Flevoland" )
        ]
        q.errors.vraag12
        "Uit welke regio ben je afkomstig?"
        "vraag12"
        q.vraag12
        Vraag12
    ]
...
inputField error desc val toUpdate =
  row
...
selectionField : List ( String, String ) -> Bool -> String -> String -> String -> (String -> Update) -> Html
selectionField options error desc n val toUpdate =
  row
    [ column 6 [ span [ getValidationErrorColor error ] [ text desc ] ]
...
createInput n toUpdate curVal ( val, desc ) =
  div
    [ class "input"
    , style [ ( "float", "left" ) ]
    , style [ ( "clear", "both" ) ]
